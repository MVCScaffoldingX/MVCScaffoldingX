...
using Xtra.Scaffolding.MVC.UI;
using Microsoft.AspNet.Scaffolding.Core.Metadata;
using Xtra.Scaffolding.MVC.Utils;
using System.IO;
using Microsoft.AspNet.Scaffolding;
using Xtra.Scaffolding.MVC;
using Xtra.Scaffolding.MVC.Models;

namespace Xtra.Scaffolding.MVC.Scaffolders
{
